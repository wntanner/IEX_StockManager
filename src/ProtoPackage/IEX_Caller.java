...
public class IEX_Caller {
	...
	/**
	 * Given a stock symbol, creates and returns a String for the URL
	 * 
	 * @param sym
	 * @return
	 */
	...
	/**
	 * Given a Stock : s, calls the IEX API Fills the Stock's attributes with
	 * whatever IEX returned
	 * 
	 * @param s
	 * @return
	 */
	public String callAndFill(Stock s) {
		...
		/*
		 * Close is a tricky thing to get, but we solved. We can remove this check.
		 */
	...
	public boolean fillStock(BufferedReader buffr, Stock s) throws IOException {
		...
		/*
		 * ... so that we can start to search for matches with the attributes we want
		 */
	...
	/**
	 * Given a BufferedReader and String, sticks num number of lines onto the String
	 * 
	 * @param buffr
	 * @param toPad
	 * @param num
